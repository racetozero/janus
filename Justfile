...
lint: setup
    ...
    cppcheck --project=compile_commands.json --file-filter='src/*' --enable=warning,style,performance,portability --inconclusive --suppress=missingIncludeSystem --suppress='*:vcpkg/*' --suppress=useStlAlgorithm --error-exitcode=1
